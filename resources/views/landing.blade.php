        ...
        <div class="col-lg-8 text-center">
          ...
          <p class="lead">
            <div class="row d-flex justify-content-between">
                ...
                <div class="col">
                  <button class="btn btn-outline-warning btn-block btn-oval btn-md" data-target="{{ $cab->keterangan }}">{{ $cab->keterangan }}</button>
                </div> @endforeach
         </p>
...
@foreach ($loker as $l)
    <div class="col-lg-6">
      <div class="card card-lift--hover shadow border-0" id="{{ getNameCabang($l->id_cabang) }}">
        <a href="URL_TUJUAN" class="card-body py-5" style="display: block; text-decoration: none;">
