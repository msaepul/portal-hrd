      ...
      <div class="row">
        ...
        @endif
            ...
            Masukan data departemen
              ...
              <button class="btn btn-primary" data-toggle="modal" data-target="#modal-default"><i class="fas fa-plus-circle"></i> Tambah</button>
              <button class="btn btn-warning"><i class="fas fa-plus-circle"></i> Loker</button>
              @include('modal.modaldept')
            </div>
              ...
              <table class="table table-flush" id="datatable-buttons">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $dept->catatan }}</td>
                      <td>
                        <a href="https://www.example.com/tambah_data">
                          <i class="fas fa-plus-circle fa-2x"></i>
                          <i class="fas fa-info-circle fa-2x" style="color: #ff9500;"></i>
                        </a>
                      </td>
                    </tr>
                    @endforeach
